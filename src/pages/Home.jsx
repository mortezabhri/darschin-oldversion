...
export default function Home() {
       ...
       return (
              <>
                     <section>
                            {/* circle on top */}
                            <div className="size-36 scale-400 bg-tertiary rounded-full absolute -top-10 left-1/2 -translate-x-1/2 shadow-lg"></div>
                            {/* header */}
                            <header className="w-full h-56 relative -top-2 flex justify-around items-center" dir="rtl">
                                   {/* titles */}
                                   <div>
                                   ...
                                   <div className="relative -translate-y-4">
                                          <svg xmlns="http://www.w3.org/2000/svg" className="size-34" viewBox="0 0 24 24" fill="none">
                                                 <path d="M3 10C3 8.11438 3 7.17157 3.58579 6.58579C4.17157 6 5.11438 6 7 6H17C18.8856 6 19.8284 6 20.4142 6.58579C21 7.17157 21 8.11438 21 10V11H3V10Z" stroke="#2A4157" strokeOpacity="0.24" strokeWidth="1.2" />
                                                 <rect x="3" y="6" width="18" height="15" rx="2" stroke="#222222" strokeWidth="1.2" />
                                                 <path d="M7 3L7 8" stroke="#222222" strokeWidth="1.2" strokeLinecap="round" />
                                                 <path d="M17 3L17 8" stroke="#222222" strokeWidth="1.2" strokeLinecap="round" />
                                          </svg>
